...
| `--native-core-backprop`      | Run the packed propagate loop via in-process `libneat_core` and require the library. Leftover `NEAT_AI_NATIVE_CORE_BACKPROP` env is ignored. Not what `--next` does.                                                                                                                          |
