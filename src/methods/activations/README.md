...
| Exponential     | ✅         | ✅ Derivative stable                | ⚠️ Inversion dangerous        |    2     | 🚀 Derivative  | Fast and reliable slope unless near limits; use derivative with clamping.                        | | 🟨 | ✅ |
| GAUSSIAN        | ✅         | ⚠️ Derivative fades                 | ✅ Inversion tough            |    2     | 🔍 Foggy       | Derivative often flat in tails; use foggy fallback unless near peak.                             | | 🟨 | ✅ |
| ISRU            | ✅         | ✅ Good with normalization          | ⚠️ Expensive                  |    2     | 🚀 Derivative  | Accurate but fades in tails; fallback improves precision.                                        | | 🟥 | ✅ |
