...
export class ELU implements ActivationInterface, UnSquashInterface {
   ...
   *
   * Fallback OR Logic:
   * - If raw value is out of safe zone and adjusting it would make it worse: avoid adjusting it
   * - If weight is out of safe range but adjusting it would improve it: prefer adjusting weight
   *
