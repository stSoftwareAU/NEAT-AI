  ...
  if (neat.config.verbose) {
    ...
    getLogger().info(
      `[Throughput] wall=${throughput.wallClockMs}ms` +
        ...
        // Issue #3234: per-backend scorer-utilisation split, so how much of
        // the population the batch scorer served is visible on the verbose log
        // line, not just in the result.
