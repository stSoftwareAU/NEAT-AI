...
## The Problem
Discovery processes were hanging indefinitely with no errors, waiting for 20+ generations (~30 minutes).
...
The anti-deadlock measures ensure that even if discovery fails, it fails **fast and clearly** instead of hanging silently.
