 ...
 *
 * The fix: deno.json excludes generated directories (wasm_activation/pkg,
 * wasm_activation/target) and quality.sh runs `deno fmt` without explicit
  ...
  fn: async () => {
    ...
    assert(
      ...
      `deno fmt should not touch wasm_activation/pkg files. ` +
        `These are generated by wasm-pack and must be excluded ` +
