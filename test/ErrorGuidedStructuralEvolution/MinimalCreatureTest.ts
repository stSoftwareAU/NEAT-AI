...
Deno.test("Discovery handles minimal creature (1 input, 1 output)", async () => {
...
Deno.test("Discovery handles small creature (2 inputs, 1 hidden, 1 output)", async () => {
  const json: CreatureExport = {
    neurons: [
      {
        type: "hidden",
...
Deno.test("Discovery selection respects neuron count limit", async () => {
