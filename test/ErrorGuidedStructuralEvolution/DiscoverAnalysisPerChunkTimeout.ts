...
Deno.test("runAnalysisLoop aborts runParallelAnalysis mid-flight when it never resolves", async () => {
  ...
  // The observable contract: the never-resolving driver was aborted
  // mid-flight and the stall was recorded. No wall-clock measurement —
  // that would be a machine-dependent HOW-test (see Issue #3365).
  assert(
