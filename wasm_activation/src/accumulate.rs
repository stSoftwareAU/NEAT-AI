...
pub(crate) fn accumulate_weight_single(
    ...
    // Issue #1653: Store raw target weight — learning rate limiting is applied
    // once during calculate_weight, not during accumulation.
...
pub(crate) fn accumulate_bias_single(
    ...
    // Issue #1653: Store raw target bias — learning rate limiting is applied
    // once during calculate_bias, not during accumulation.
