 ...
 * @param {number} error
 * @param {Float64Array} activations
 * @param {Float64Array} safe_zone_factors
...
export function distribute_elastic_error(
  ...
  const ptr0 = passArrayF64ToWasm0(activations, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArrayF64ToWasm0(safe_zone_factors, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
