 ...
 */
export function distribute_elastic_error(error: number, activations: Float64Array, safe_zone_factors: Float64Array, weights: Float64Array, plank_constant: number): Float64Array;
