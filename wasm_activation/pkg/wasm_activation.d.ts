 ...
 */
export function fused_backprop_neuron(current_weights: Float64Array, target_values: Float64Array, activations: Float64Array, plank_constant: number, learning_rate: number, max_weight_adj_scale: number, limit_weight_scale: number, target_pre_activation: number, pre_activation: number, current_bias: number, max_bias_adj_scale: number, limit_bias_scale: number): Float64Array;
...
export interface InitOutput {
    ...
    readonly fused_backprop_neuron: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => [number, number];
