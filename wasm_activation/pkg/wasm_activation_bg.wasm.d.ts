...
export const scan_available_connections: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const validate_structural_integrity: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const validate_topology: (
  a: number,
  b: number,
  c: number,
  d: number,
) => [number, number];
export const validate_topology_batch: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const calculate_bias_batch_4way: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const calculate_weight_batch_4way: (
  a: number,
  b: number,
  c: number,
  d: number,
