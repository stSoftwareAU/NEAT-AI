...
- Seed 17, 64 probe samples, up to 3 synapses per arm (the null arm matched to what the skip arm added), weight scale 0.01, observation scale 3, 300 training epochs
