...
- Test coverage for merge conflict JSON handling (`test/fix/MergeConflictJSON.ts`)
...
- `test/fix/MergeConflictJSON.ts` covers the new merge conflict cleaning functionality
