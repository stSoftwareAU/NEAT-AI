...
- [x] Each new parser file has at least one happy-path and one invalid-input
      test under `test/config/parsers/`.
...
- Full quality gate passes: `./quality.sh --skip-discovery --skip-wasm` → 6118
