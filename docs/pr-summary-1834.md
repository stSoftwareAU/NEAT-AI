...
2. **CNN (Convolutional Neural Network)** — pipeline from image to classification
...
Each diagram uses colour styling, emoji labels, and informative descriptions.
No `+---+` style box-drawing characters remain outside tables. Australian
